...
export const BOOK_META = [
  ...
  { n: 5,  count: 36, enhanced: true, note: { en: 'On duty, labour, and the common work.', ru: 'О долге и общем труде.' },
...
export const UI = {
  en: {
    ...
    tools_copy_failed: 'Copying is blocked in this browser',
    ...
    about_author_head: 'About the site author',
    about_author_p1: 'Made by Ian Mezinskii — for quiet reading, without ads or commentary.',
    about_author_link: 'More of his work at mezinskii.com →',
    about_author_email_label: 'Email',
    newsletter: 'Newsletter',
    footer_copy: 'Texts in the public domain. Web edition © 2026.',
    footer_made_pre: 'Made by ',
    footer_author: 'Ian Mezinskii',
  ...
  ru: {
    ...
    tools_copy_failed: 'Браузер запретил копирование',
    ...
    about_author_head: 'Об авторе сайта',
    about_author_p1: 'Проект сделал Ян Мезинский — для спокойного чтения без рекламы и комментариев.',
    about_author_link: 'Другие проекты — на mezinskii.com →',
    about_author_email_label: 'Почта',
    newsletter: 'Рассылка',
    footer_copy: 'Тексты в public domain. Веб-издание © 2026.',
    footer_made_pre: 'Автор: ',
    footer_author: 'Ян Мезинский',
